        ...
        if (pictureShowingCount < 2) {
            ...
            timerList[4] = setTimeout(() => {
                characterList.map(character => {
                    character.current.className = 'show'
                })
            }, 300);
    ...
    function changeRoundCart() {
        ...
        if (pictureShowingCount < backgroundList.length - 1) {
            timerList[14] = setTimeout(() => {
                if (backShowingCount % 2 != 0)
                    introPanel1.current.setUrl('SB_37_FG/' + roundBackList[pictureShowingCount + 1] + '.svg')
                else
                    introPanel.current.setUrl('SB_37_FG/' + roundBackList[pictureShowingCount + 1] + '.svg')
            }, 1000);
        }
    }
            ...
            <div >
                ...
                <div
                    ...
                    <BaseImage
                        ...
                        url={"SB_37_FG/" + roundBackList[1] + ".svg"}
                    />
                    <BaseImage
                        ref={introPanel1}
                        url={"SB_37_FG/" + roundBackList[0] + ".svg"}
                    />
                    ...
                    <BaseImage
                        ref={introAnimal}
                        scale={dangerAnimalInfolist[1].s}
                        className='hideObject'
                        posInfo={dangerAnimalInfolist[1]}
                        url={"SB_37_Character-Interactive/" + dangerAnimallist[1] + ".svg"}
                    />
                    <BaseImage
                        ref={introAnimal1}
                        scale={dangerAnimalInfolist[0].s}
                        posInfo={dangerAnimalInfolist[0]}
                        url={"SB_37_Character-Interactive/" + dangerAnimallist[0] + ".svg"}
                    />
